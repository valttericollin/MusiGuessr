...
func newClient(conn *websocket.Conn, gameServer *GameServer) *Client {
	return &Client{
		conn:       conn,
		gameServer: gameServer,
...
func serveGame(gameServer *GameServer, w http.ResponseWriter, r *http.Request) {
	...
	client := newClient(conn, gameServer)
